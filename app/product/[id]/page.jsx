  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
      ...
      <nav className="text-sm text-luxury-muted mb-10">
        <Link href="/" className="hover:text-luxury-text transition-colors">
          Home
        </Link>
        ...
        <span className="mx-2">/</span>
        <span className="text-luxury-text truncate max-w-[200px] inline-block align-bottom">
          {product.title}
        </span>
      </nav>
        ...
        <div className="lg:py-4">
          ...
          <div className="border-t border-b border-luxury-border py-6 mb-10 divide-y divide-luxury-border">
            <div className="flex justify-between text-sm py-3">
              <span className="text-luxury-muted uppercase tracking-wider text-xs">
                Condition
              </span>
          ...
          {/* Description */}
          <div className="mb-10">
            <h3 className="text-xs font-semibold tracking-widest uppercase text-luxury-muted mb-4">
              The Story
            </h3>
      ...
      {similarProducts && similarProducts.length > 0 && (
        <section className="border-t border-luxury-border pt-20">
          <div className="text-center mb-14">
            <p className="text-luxury-accent text-sm font-semibold tracking-widest uppercase mb-2">
              Curated For You
            </p>
            <h2 className="font-serif text-3xl md:text-4xl text-luxury-text">
              You May Also Like
            </h2>
          </div>
