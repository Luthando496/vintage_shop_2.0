...
// FIX: Moved OUTSIDE the main component to prevent input focus loss on re-render
...
export default function LoginPage() {
  ...
  // Get the redirect URL from the query params (e.g., ?redirect=/checkout), default to home if not present
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isRegister) {
        ...
        // Since we turned off email confirmation, they are logged in immediately.
        router.refresh();
        router.push(redirectUrl); // Redirects to checkout (or home)
      } else {
      ...
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-sm text-luxury-muted mt-8">
          ...
          <button
            ...
            className="text-luxury-text font-medium hover:text-luxury-accent transition-colors underline"
          >
